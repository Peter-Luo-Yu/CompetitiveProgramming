...
// I needed chat to tell me the strategy to solving this problem. 
// Basically at the start of each interval you can do a reset or not
// And the DP has to look through all previous possibilities to minimized the current state
